...
<![endif]-->
<title>${sessionScope.session.title}-包裹信息管理</title>
</head>
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 包裹信息管理 <span class="c-gray en">&gt;</span> 包裹管理 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	<div class="text-l"> 包裹编号：
		<input type="text" class="input-text" style="width:150px" placeholder="包裹编号" id="packageMum" maxlength="20">
		&nbsp;&nbsp;
		设备编号:
		<input type="text" class="input-text" style="width:150px" placeholder="设备编号" id="deviceNum" maxlength="11">
...
function createPage(){
	...
	if($.trim($("#packageMum").val()) != ""){
		reqParam['pkgNmu'] = $.trim($("#packageMum").val());
	}
	if($.trim($("#deviceNum").val()) != ""){
		reqParam['deviceNum'] = $.trim($("#deviceNum").val());
	}
	$.ajax({
		type : "get",
		timeout : 10000,
		...
		success : function(data) {
			...
			for(var i = 0; i< obj.length;i++){
				...
				html += "<td  class=\"text-c\">"+obj[i].orderInfo.pkgNum+"</td>";
				html += "<td  class=\"text-c\">"+obj[i].device.devNum+"</td>";
				html += "<td  class=\"text-c\">"+obj[i].length+"</td>";
				html += "<td  class=\"text-c\">"+obj[i].width+"</td>";
				html += "<td  class=\"text-c\">"+obj[i].height+"</td>";
				html += "<td  class=\"text-c\">"+obj[i].weight+"</td>";
				html += "<td  class=\"text-c\">"+obj[i].paymentAmount+"</td>";
				html += "<td  class=\"text-c\">"+obj[i].createDate+"</td></tr>";
