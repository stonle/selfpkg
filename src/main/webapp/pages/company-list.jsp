...
<div class="page-container">
	 <div class="text-l"> <!-- 用户姓名：
		...
		&nbsp;&nbsp; --><button type="submit" class="btn btn-primary radius hide" id="doQuery" name=""><i class="Hui-iconfont">&#xe665;</i> 查询</button>
	</div>
	...
	$.ajax({
		...
		success : function(data) {
			...
			for(var i = 0; i< obj.length;i++){
				html += "<tr class=\"text-c\"><td><input type=\"checkbox\" value=\""+obj[i].copId+"\" name=\"item\"></td>";
				html += "<td  class=\"text-c\">"+(i+1)+"</td>";
				html += "<td  class=\"text-c\">"+obj[i].copName+"</td>";
