...
<![endif]-->
<title>${sessionScope.session.title}-快递员</title>
</head>
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>快递公司管理<span class="c-gray en">&gt;</span> 快递员管理<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新"><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	...
	<div class="cl pt-5 pl-5 pr-5 bg-1 bk-gray mt-15"> 
    	...
    	<span class="l">
			...
			<a href="javascript:;" onclick="data_del()" class="btn btn-danger radius size-S"><i class="Hui-iconfont">&#xe6e2;</i> 删除快递员</a> 
		</span> 
