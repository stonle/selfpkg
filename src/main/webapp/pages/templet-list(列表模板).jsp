...
<![endif]-->
<title>${sessionScope.session.title}-X'X管理</title>
</head>
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> X'X管理 <span class="c-gray en">&gt;</span> X'X管理 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	<div class="text-l"> X'X'X：
		...
		日期：
		<input type="text" id="pickupDate" class="input-text Wdate size-S" placeholder="请选择" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'2013-01-01',maxDate:'%y-%M-%d'})" style="width:100px;">	
		
		&nbsp;&nbsp;<button type="submit" class="btn btn-primary radius" id="query-data" name=""><i class="Hui-iconfont">&#xe665;</i> 查询</button>
	</div>
	<div class="cl pd-5 bg-1 bk-gray mt-20"> 
		<span class="l">
			<a href="javascript:;" onclick="data_add('添加XX','XX-add.jsp','800','500')" class="btn btn-primary radius size-S"><i class="Hui-iconfont">&#xe600;</i> 添加XX</a>
			<a href="javascript:;" onclick="data_del()" class="btn btn-danger radius size-S"><i class="Hui-iconfont">&#xe6e2;</i> 删除XX</a> 
		</span> 
...
function createPage(){
	...
	reqParam['pageSize'] = $("#pageSize").val();//每页数量
